      ...
      <div className="flex w-full flex-col items-center py-10 text-xl xl:w-1/2 xl:items-end">
        <div className="w-fit">
          ...
          <h1 className="pt-2 text-3xl font-bold text-primaryColor opacity-70 sm:text-5xl">
            Andrew Gong <span className="text-3xl font-extrabold text-themePrimaryColor sm:text-5xl">{'/>'}</span>{' '}
          </h1>
          <TypeAnimation
            sequence={['Animator', 1000, 'React Developer', 1000, 'Back-End Developer', 1000, 'Front-End Developer', 1000]}
            wrapper="span"
            speed={1}
            style={{
              paddingTop: '8px',
